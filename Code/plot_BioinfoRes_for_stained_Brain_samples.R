...
mets_id <- c("BM52", "BM71", "BM72")
pri_id <- c("BP52", "BP71", "BP72")
id <- c(pri_id, mets_id)
pair_id <- rep(c("BP/BM52", "BP/BM71", "BP/BM72"), 2)
...
save(ciber_rel_sub, file="Results_v2/Brain_mets_stainedSample_bioinfo_score.RData")
...
plot_data <- function(data_index){
	...
	pdf(file=paste0("Results_v2/Brain_staining_samples_", 
